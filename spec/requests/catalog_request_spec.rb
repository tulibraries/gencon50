...
RSpec.describe "Catalogs", type: :request do
  ...
  context "catalog record page" do
    subject {
      VCR.use_cassette("responseCatalogRecordPage", record: :once) do
  ...
  context "search" do
    describe "all fields" do
      subject {
        VCR.use_cassette("responseSearchAllFields", record: :once) do
    ...
    describe "summary in all fields" do
      subject {
        ...
        VCR.use_cassette("responseSummaryInAllFields", record: :once) do
    ...
    describe "Title Search" do
      subject {
        VCR.use_cassette("responseTitleSearch", record: :once) do
    ...
    describe "Game System Search" do
      subject {
        VCR.use_cassette("responseGameSystemSearch", record: :once) do
    ...
    describe "Event Type Search" do
      subject {
        VCR.use_cassette("responseEventTypeSearch", record: :once) do
    ...
    describe "Long Description Search" do
      subject {
        ...
        VCR.use_cassette("responseLongDescriptionSearch", record: :once) do
          get "?search_field=all_fields&q=" + search_text
        end
        response.body
      }
    ...
    describe "GM Name Search" do
      subject {
        VCR.use_cassette("responseGMNameSearch", record: :once) do
    ...
    describe "Group Search" do
      subject {
        VCR.use_cassette("responseGroupSearch", record: :once) do
    ...
    describe "Location Search" do
      subject {
        VCR.use_cassette("responseLocationSearch", record: :once) do
  ...
  context "facet" do
    describe "Year Facet Search" do
      subject {
        VCR.use_cassette("responseYearFacetSearch", record: :once) do
    ...
    describe "Group Facet Search" do
      subject {
        VCR.use_cassette("responseGroupFacetSearch", record: :once) do
    ...
    describe "Event Type Facet Search" do
      subject {
        VCR.use_cassette("responseEventTypeFacetSearch", record: :once) do
    ...
    describe "Game System Facet Search" do
      subject {
        VCR.use_cassette("responseGameSystemFacetSearch", record: :once) do
  ...
  context "Embedded ID's in ID" do
    subject {
      VCR.use_cassette("responseEnbeddedIdsInIdSearch", record: :once) do
